 ...
 */
function buildStoresJs(records, generatedAt) {
  const runtime = `
(function () {
  ...
  return [
    '/* R.Greenleaf store data — generated by Vireo-Health/store-data. Do not edit by hand. */',
...
function generate(stores, generatedAt) {
  const records = buildRecords(stores);
  return {
    'stores.json': JSON.stringify({ generatedAt, stores: records }, null, 2) + '\n',
    'stores.js': buildStoresJs(records, generatedAt),
    'store-schema.json': JSON.stringify(buildSchema(stores), null, 2) + '\n',
  };
}
